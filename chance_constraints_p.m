function [c_chance,ceq_chance]=chance_constraints_p(x,u,T,id_vehicle, params_vehicles,number_vehicles,id_lane_vehicles,distance_detectable,N,risk_parameter,states_vehicles)
